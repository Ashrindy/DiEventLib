...
public class DvElementSpotlight : DvNodeObject
{
    ...
    public float[] AnimData { get; set; } // ev0010_mov contains a string in there? it looks like either the one i found was a newer version, or the compiler messed up or i'm just missing something.
