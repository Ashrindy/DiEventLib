...
public class DvElementMaterialAnimation : DvNodeElement
{
    ...
    public DvElementMaterialAnimation() : base(DvElementID.MaterialAnimation) { }
    public DvElementMaterialAnimation(BinaryObjectReader reader)
        => Read(reader);
