...
public static class Utils
{
    ...
    public static void WriteAt(this BinaryObjectWriter writer, long position, Action action)
    {
    ...
    public static void WriteAt<T>(this BinaryObjectWriter writer, long position, T value) where T : unmanaged
    {
        long prePos = writer.Position;
        writer.Seek(position, SeekOrigin.Begin);
        writer.Write(value);
