            ...
            case DvNodeCategory.Element:
                ...
                switch (elementID)
                {
                    ...
                    case DvElementID.ModelFade:
                        ...
                        break;
                    case DvElementID.DebugMotion:
                        element = new DvElementDebugMotion(reader);
                        break;
                    ...
                    case DvElementID.CameraInGame:
                        ...
                        break;
                    case DvElementID.PointLight:
                        element = new DvElementPointLight(reader);
                        break;
                    ...
                    case DvElementID.Spotlight:
                        ...
                        break;
                    case DvElementID.ControllerVibration:
                        element = new DvElementControllerVibration(reader);
                        break;
                ...
                element.UnkFlag = (flags & 1) != 0;
                element.LooseLength = (flags & 2) != 0;
