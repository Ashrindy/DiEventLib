...
[DvNodeDescription("Point Light", "")]
public class DvElementPointLight : DvNodeElement
{
    ...
    public DvElementPointLight() : base(DvElementID.PointLight) { }
    public DvElementPointLight(BinaryObjectReader reader)
        => Read(reader);
